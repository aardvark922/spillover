...
def get_quiz_data():
    return [
        ...
        dict(
            name='Q2',
            solution=True,
            explanation="During each match, you will be asked to make decisions with the same four participants"
        ...
        dict(
            ...
            explanation="The length of a match, i.e. the number of rounds in a match, is randomly determined as "
                        "follows: "
                        "<br> After each round, there is a 75% probability that the match will continue for at least "
                        "another round.",
        ),
        dict(
            name='Q4',
            ...
            explanation="During each match, you will be asked to make decisions with the same four participants over "
                        "a sequence of rounds for both games at the same time.",
        ),
        dict(
            name='Q5',
            solution=2,
        ...
        dict(
            name='Q6',
            solution=3,
            explanation="Total payoffs formula <br>"
        ...
        dict(
            name='Q7',
            solution=2,
            explanation="As shown below, your payoff is",
        ),
        # dict(
        #     name='Q8',
        #     solution=False,
